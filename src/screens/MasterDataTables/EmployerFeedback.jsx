...
import { deleteFeedback, deleteFeedbacks, deleteJobCategories, deleteJobCategory, deleteSkill, deleteSkills, getFeedback, getJobCategory, getSkills } from '../../redux/Action/CommonAction';
...
export default function JobCategory() {
    ...
    const FeedbackData = useSelector(
        (state) => state.CommonReducer.feedback
    );
