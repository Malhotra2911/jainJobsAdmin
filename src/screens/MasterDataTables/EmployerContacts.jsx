...
import { deleteFeedback, deleteFeedbacks, deleteJobCategories, deleteJobCategory, deleteSkill, deleteSkills, getContacts, getFeedback, getJobCategory, getSkills } from '../../redux/Action/CommonAction';
...
export default function EmployerContacts() {
    ...
    const rows = JOBSeekerFeedbackData;
    ...
    const handleSelectAllClick = (event) => {
        if (event.target.checked) {
            const newSelected = rows.map((n) => n.FEEDBACK_ID);
                                    ...
                                    {rows
                                        ...
                                        .map((row, index) => {
                                            ...
                                            return (
                                                <TableRow
                                                    hover
                                                    onClick={(event) => handleClick(event, row.FEEDBACK_ID)}
                                                    role="checkbox"
